...
export class Backend implements backendInterface {
    ...
    async createRecutsProject(arg0: string, arg1: string, arg2: RecutsSettings): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createRecutsProject(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteRecutsProject(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteRecutsProject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecutsProjectById(arg0: bigint): Promise<Project> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecutsProjectById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecutsProjectsByCaller(): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecutsProjectsByCaller();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRecutsProject(arg0: bigint, arg1: string, arg2: string, arg3: RecutsSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRecutsProject(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
